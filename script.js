...
const SAFETY_MESSAGES = {
  ...
  riding: 'Safety: Using your phone while riding (bike, scooter, or motorcycle) is dangerous. Stop in a safe place before you check your device.',
  gaming: 'Health: Long gaming sessions strain eyes, posture, and sleep. Take a 10–15 minute break every hour. Stretch and rest your eyes.',
...
const WELLBEING_SLOTS = [
  ...
  { h: 12, m: 0, msg: 'Midday pause. Eat, hydrate, and step away from screens. Avoid phone use while walking to lunch.' },
  { h: 14, m: 30, msg: 'Afternoon focus. Close one open loop. Remember: never use the phone while driving or riding.' },
  { h: 16, m: 30, msg: 'Late afternoon: Review progress. If screen time has been long, take a short walk without the phone.' },
